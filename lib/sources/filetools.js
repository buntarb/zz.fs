...
zz.fs.FileTools = function( ){
     ...
     * @type {boolean}
     */
    this.isWidowsOs_ = undefined;
}


/**********************************************************************************************************************
 * Proxy methods wrapped by the zz.fs.FileTools                                                                       *
 **********************************************************************************************************************/
...
zz.fs.FileTools.prototype.isWidowsOs = function( ) {
    ...
    if( !goog.isDefAndNotNull( this.isWidowsOs_ ) ){

        this.isWidowsOs_ = /windows/i.test( process.env[ 'OS' ] );
    }

    return this.isWidowsOs_;
};
